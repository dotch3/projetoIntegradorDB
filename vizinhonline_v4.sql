...
CREATE TABLE IF NOT EXISTS `vizinhonline`.`ITEMS` (
  ...
  `itemsstatus_id` INT(11) NOT NULL,
  `created_at` DATETIME NULL,
  `updated_at` DATETIME NULL,
  `deleted_at` DATETIME NULL,
  PRIMARY KEY (`id`, `itemsstatus_id`),
...
-- -----------------------------------------------------
-- Table `vizinhonline`.`FEEDBACK_ITEMS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `vizinhonline`.`FEEDBACK_ITEMS` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `vizinhonline`.`FEEDBACK_ITEMS` (
  `id` INT(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `vizinhonline`.`CATEGORIES_ITEMS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `vizinhonline`.`CATEGORIES_ITEMS` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `vizinhonline`.`CATEGORIES_ITEMS` (
...
-- -----------------------------------------------------
-- Table `vizinhonline`.`ITEMS_STATUS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `vizinhonline`.`ITEMS_STATUS` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `vizinhonline`.`ITEMS_STATUS` (
  `id` INT(5) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `vizinhonline`.`FEEDBACK_USERS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `vizinhonline`.`FEEDBACK_USERS` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `vizinhonline`.`FEEDBACK_USERS` (
  `id` INT(5) UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` VARCHAR(45) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `vizinhonline`.`LEND_ITEMS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `vizinhonline`.`LEND_ITEMS` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `vizinhonline`.`LEND_ITEMS` (
  `id` INT(5) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `vizinhonline`.`ITEMS_USERS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `vizinhonline`.`ITEMS_USERS` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `vizinhonline`.`ITEMS_USERS` (
  `id` INT(5) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `vizinhonline`.`USERS_POSTS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `vizinhonline`.`USERS_POSTS` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `vizinhonline`.`USERS_POSTS` (
  `id` INT(5) UNSIGNED NOT NULL AUTO_INCREMENT,
  `user_id` INT(5) UNSIGNED ZEROFILL NOT NULL,
...
-- -----------------------------------------------------
-- Table `vizinhonline`.`FAVORITES_USERS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `vizinhonline`.`FAVORITES_USERS` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `vizinhonline`.`FAVORITES_USERS` (
  `id` INT(5) NOT NULL AUTO_INCREMENT,
  `user_id` INT(5) UNSIGNED ZEROFILL NOT NULL,
...
-- -----------------------------------------------------
-- Table `vizinhonline`.`IMAGES_ITEMS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `vizinhonline`.`IMAGES_ITEMS` ;

SHOW WARNINGS;
CREATE TABLE IF NOT EXISTS `vizinhonline`.`IMAGES_ITEMS` (
  ...
  `updated_at` DATETIME NULL,
  `deleted_at` DATETIME NULL,
  PRIMARY KEY (`id`, `image_id`, `item_id`, `itemsstatus_id`))
ENGINE = InnoDB;
...
USE `vizinhonline`$$
DROP TRIGGER IF EXISTS `vizinhonline`.`score` $$
SHOW WARNINGS$$
USE `vizinhonline`$$
CREATE
...
USE `vizinhonline`$$
DROP TRIGGER IF EXISTS `vizinhonline`.`score_update` $$
SHOW WARNINGS$$
USE `vizinhonline`$$
CREATE
DEFINER=`root`@`localhost`
